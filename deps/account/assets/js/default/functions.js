...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    if ($theme === 'light') {
        $logo.attr('src', $mediaUrl + 'account/assets/images/logo.png');
        ...
        $themeStylesheet.href = $baseUrl + 'account/assets/css/default/theme-' + $theme + stylePath + rtlString + '.css';

    } else if ($theme === 'dark') {

        $logo.attr('src', $mediaUrl + 'account/assets/images/logo-white.png');
        $body.removeClass('theme-semidark').addClass('theme-dark');
        $themeStylesheet.href = $baseUrl + 'account/assets/css/default/theme-' + $theme + rtlString + '.css';
